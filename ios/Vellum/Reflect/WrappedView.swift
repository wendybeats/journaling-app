// The yearly wrapped — Vellum's one moment of theater, still monochrome,
        ...
        s.append(SequenceSlide(duration: 6) {
            VStack(spacing: Tokens.Space.lg) {
                ...
                Text(String(signal.year))
                    .font(.custom(VellumFont.meta, size: 11))
                    .tracking(11 * 0.14)
                    ...
                    ForEach(Array(signal.topics.enumerated()), id: \.offset) { _, topic in
                        HStack(spacing: Tokens.Space.md) {
                            ...
                            Text("\(topic.days) days")
                                .font(.custom(VellumFont.meta, size: 10))
                                .tracking(10 * 0.14)
                                .textCase(.uppercase)
        ...
        VStack(spacing: Tokens.Space.lg) {
            ...
            if let shareImage {
                ShareLink(
                    ...
                    Text("Save your year")
                        .font(.custom(VellumFont.meta, size: 13))
                        .tracking(13 * 0.14)
                        .textCase(.uppercase)
                        .foregroundStyle(Tokens.Text.onInverted)
                }
...
private struct YearShareCard: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            Text(String(signal.year))
                .font(.custom(VellumFont.meta, size: 12))
                .tracking(12 * 0.14)
