# Endpaper — Stage 2 Plan: Account & Recovery, Onboarding, Reminder
...
reflection layer), swipe or tap to advance, mono `SKIP` top-right. Progress indicator: **three Endpaper dots**, the current page's dot filled — the habit metaphor, taught silently before a word about it is read.
...
2. **What** — display heading: "This is Endpaper."
