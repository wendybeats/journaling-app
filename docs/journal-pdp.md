...
- **Monetization:** ✅ **Decided (July 8, 2026): paid subscription with a 7-day free trial, hard paywall, no freemium.** The trial moment ("A week on me." — personal, first-person comms) sits at the end of onboarding; nothing works without starting the trial. ✅ **Price decided (July 27, 2026): $39.99/yr, annual-only, no monthly** — lifestyle positioning, locking in is the play (research: docs/endpaper-pricing-research.md). The subscription carries the reflections' ongoing AI cost.
